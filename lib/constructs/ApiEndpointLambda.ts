...
export class ApiEndpointLambda extends Construct {
	...
	constructor(scope: Construct, id: string, props: ApiEndpointLambdaProps) {
		...
		const handlerLambda = new lambda.Function(this, `${id}Function`, props.handlerFunctionProps);
		...
		if (props.authorizer) routeProps.authorizerId = props.authorizer.attrAuthorizerId;
